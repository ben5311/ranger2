...
import { noHighlight } from '../../src/language-server/ast/CodeHighlighter';
...
describe('RangerHoverProvider', () => {
    ...
    test('today()', async () => {
        ...
        let [date] = (doc.entities[0].value as Objekt).properties;
    ...
    test('now()', async () => {
        ...
        let [timestamp] = (doc.entities[0].value as Objekt).properties;
